...
WriteStallCondition ColumnFamilyData::RecalculateWriteStallConditions(
  ...
  if (current_ != nullptr) {
    ...
    //==========SATune========
    write_controller->SetStallCause(write_stall_cause);
    //==========SATune========
    ...
    if (write_stall_condition == WriteStallCondition::kStopped &&
      ...
      write_controller_token_ = write_controller->GetStopToken();
      //===SATune====
      write_controller->SetL0FileCount(vstorage->l0_delay_trigger_count());
      //===SATune====
      ...
      // ============================================================================
      // SATune: Clear stall cause when returning to normal state
      write_controller->SetStallCause(WriteStallCause::kNone);
      // ============================================================================
