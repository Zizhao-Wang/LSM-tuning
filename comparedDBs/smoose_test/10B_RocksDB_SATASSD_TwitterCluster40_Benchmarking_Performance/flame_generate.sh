...
# perf.data 文件的路径
PERF_DATA_FILE="/home/jeff-wang/LSM-tuning/comparedDBs/smoose_test/10B_RocksDB_SATASSD_TwitterCluster40_Benchmarking_Performance/perf_smoose.data"

# FlameGraph 工具的目录路径
FLAMEGRAPH_DIR="/home/jeff-wang/FlameGraph"

# 输出目录（火焰图和报告会保存到这里）
OUTPUT_DIR="/home/jeff-wang/LSM-tuning/comparedDBs/smoose_test/10B_RocksDB_SATASSD_TwitterCluster40_Benchmarking_Performance/flame_results"

# 输出火焰图的文件名（不包含.svg扩展名）
OUTPUT_NAME="smoose_flamegraph"
