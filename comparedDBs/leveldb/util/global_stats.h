...
struct InternalGetStats {
    ...
    InternalGetStats() : index_block_seek_time(0), filter_check_time(0),
        block_load_seek_time(0),total_time(0){}
...
struct GlobalGetStats {
  ...
  GlobalGetStats() : index_block_seek_time(0), filter_check_time(0), block_load_seek_time(0),total_time(0) {}
  ...
  void Add(const InternalGetStats& stats) {
    ...
    total_time.fetch_add(stats.total_time, std::memory_order_relaxed);
  }
};
