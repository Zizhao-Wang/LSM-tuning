...
declare -A param_map=(
  ...
  ["25_200000000_1000"]="5"
  ["25_200000000_5000"]="8"
  ["25_200000000_10000"]="10"

  # cluster=25, num_kvs2=300M
  ["25_400000000_300"]="3"
  ["25_400000000_1000"]="5"
  ["25_400000000_5000"]="8"
  ["25_400000000_10000"]="10"

  # cluster=25, num_kvs2=300M
  ["25_600000000_300"]="3"
  ["25_600000000_1000"]="5"
  ["25_600000000_5000"]="8"
  ["25_600000000_10000"]="10"

  # cluster=25, num_kvs2=300M
  ["25_800000000_300"]="3"
  ["25_800000000_1000"]="5"
  ["25_800000000_5000"]="8"
  ["25_800000000_10000"]="10"

  # cluster=25, num_kvs2=300M
  ["25_1000000000_300"]="3"
  ["25_1000000000_1000"]="5"
  ["25_1000000000_5000"]="8"
  ["25_1000000000_10000"]="10"

  ["40_200000000_1000"]="10"
)
...
for i in {10..10}; do
    base_num=$(($billion * $i))
    dir1="Autotuning_RocksDB_SATASSD_TwitterCluster40_Benchmarking"
    if [ ! -d "$dir1" ]; then
        mkdir $dir1
    fi
        cd $dir1
        for value_size in 128; do
            for cluster_a in 40; do  # 
                for ct0 in 4 ; do  # 
                for mb in 512; do
                for buffer_size in 67108864; do
                for num_kvs2 in 200000 ; do
                num_format3=$(convert_to_billion_format "$num_kvs2")
                    for workload_kvs in 200000000 ; do #200000000 300000000 400000000 500000000
                    stats_interva=$((workload_kvs / 5))
                    ...
                    for table_cache_size in 1000; do
                        ...
                        ../../../rocksdb/release/db_bench \
                            ...
                            perf record -F 999 -p $DB_BENCH_PID -g -e cycles:u,instructions:u -o "perf_rocksdb.data"  &
                            PERF_PID=$!
