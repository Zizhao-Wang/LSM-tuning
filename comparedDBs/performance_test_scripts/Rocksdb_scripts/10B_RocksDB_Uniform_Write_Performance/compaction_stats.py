...
# 设置日志目录路径
log_dir = Path("/home/jeff-wang/LSM-tuning/comparedDBs/performance_test_scripts/Rocksdb_scripts/10B_RocksDB_Uniform_Write_Performance")
...
filename_pattern = re.compile(
    r"zipf(?P<zipf>[\d.]+)_CT0(?P<ct0>\d+)_level1base(?P<l1base>\d+)_targetbase"
)
