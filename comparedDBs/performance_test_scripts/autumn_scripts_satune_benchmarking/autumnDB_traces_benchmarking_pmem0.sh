...
for i in 48 ; do
    dir1="AutumnDB_SATASSD_MultiTwitterClusters_Benchmarking_Performance_pmem0"
    if [ ! -d "$dir1" ]; then
        mkdir $dir1
    fi
        cd $dir1
            for cluster_a in "$i"; do  # 
                ...
                for workload_kvs in 100000000; do 
                    ...
                    for table_cache_size in 0 ${cluster_table_size_map[$cluster_a]}; do
                        ...
                        # 创建相应的目录
                        db_dir="/mnt/pmem0/Autumn10B/Load_Cluster${cluster_a}_mem${buffer_size_mb}MB_CT${ct0}_Blkcache${blk_cache_size}_Tabcache${table_cache_size}"
