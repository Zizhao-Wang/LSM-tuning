...
if __name__ == "__main__":
    ...
    input_log_file = os.path.join(current_dir, "leveldb_1B_val_128_mem64MB_cluster35_factor10_L1512MiB.log")  # 输入日志文件
    output_csv_file = os.path.join(current_dir, "leveldb_performance_data_35.csv")  # 输出CSV文件
