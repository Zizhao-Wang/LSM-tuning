...
for workload_id in 51 49 40 13 35; do
    ...
    case $workload_id in
        51) cache_sizes+="3145728";  open_files_list+="3";  key_sizes+="24"; value_sizes+="1000" ;;
        49) cache_sizes+="3145728";  open_files_list+="3";  key_sizes+="24"; value_sizes+="1000" ;;
        ...
        35) cache_sizes+="8388608";  open_files_list+="20";  key_sizes+="24"; value_sizes+="1000" ;;
    esac
done
