...
for workload_id in 35 13 40 49 51; do
    ...
    case $workload_id in
        51) cache_sizes+="3145728";  open_files_list+="100";  key_sizes+="24"; value_sizes+="1000" ;;
        49) cache_sizes+="3145728";  open_files_list+="100";  key_sizes+="24"; value_sizes+="1000" ;;
        ...
        35) cache_sizes+="8388608";  open_files_list+="30";  key_sizes+="24"; value_sizes+="1000" ;;
    esac
done
        ...
        cd $dir1
                ...
                for workload_kvs in 100000000 ; do 
                    ...
                    for mu in 10; do
                        ...
                        log_file="RocksDB_Dynamic_${num_format2}_val${value_size_twitter}_mem${buffer_size_mb}MB_Cluster${cluster_a}_CT0${ct0}_L1${mb}_Blkcache${blk_cache_size}_Tabcache${table_cache_size}_f${mu}.log"
