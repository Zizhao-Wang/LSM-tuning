...
for i in 49; do
    dir1="RocksDB_S4510_Benchmarking_ZippyDB_GPT5.2"
    if [ ! -d "$dir1" ]; then
        mkdir $dir1
    fi
        cd $dir1
            for cluster_a in "$i"; do  # 
                ...
                for workload_kvs in 100000000 ; do 
                    ...
                    for table_cache_size in 0 ; do
                        ...
                        log_file="RocksDB_ZippyDB_mem${buffer_size_mb}MB_Blkcache${blk_cache_size}_Tabcache${table_cache_size}GPT5.2_nvme.log"
                        ...
                        ../../../rocksdb/release/db_bench \
                            ...
                            --level0_slowdown_writes_trigger=15 \
