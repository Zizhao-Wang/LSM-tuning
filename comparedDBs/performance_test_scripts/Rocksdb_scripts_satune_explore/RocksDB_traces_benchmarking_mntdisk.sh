...
cluster_num_kvs_map[48]="200000000"
...
for i in 48 40 51 12 13; do
    dir1="RocksDB_SATASSD_TwitterCluster${i}_Benchmarking_Performance"
    if [ ! -d "$dir1" ]; then
        mkdir $dir1
    fi
        cd $dir1
            for cluster_a in "$i"; do  # 
                ...
                for workload_kvs in ${cluster_num_kvs_map[$cluster_a]} ; do 
                    ...
                    for table_cache_size in 50 100; do
