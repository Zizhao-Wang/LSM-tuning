        ...
        cd $dir1
            ...
            for cluster_a in "$i"; do  # 
                ...
                for table_cache_size in 1000 ; do
                    ...
                    db_dir="/mnt/ssd1/SATune10B/PreLoad_Cluster${cluster_a}_${num_format}_mem${buffer_size_mb}MB_CT${ct0}_L1${mb}_targetbase${target_file_base_mb}_F${multiplier}_Switch${multiplier_switch}_2F${after_multiplier}"
                    db_dir_other_levels="/mnt/ssd2/SATune10B/PreLoad_Cluster${cluster_a}_${num_format}_mem${buffer_size_mb}MB_CT${ct0}_L1${mb}_targetbase${target_file_base_mb}_F${multiplier}_Switch${multiplier_switch}_2F${after_multiplier}"
                    level_config_tag="L1-6_on_Disk2"
