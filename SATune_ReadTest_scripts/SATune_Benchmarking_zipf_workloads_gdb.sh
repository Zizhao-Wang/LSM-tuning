...
for i in {10..10}; do
  ...
  for value_size in 100; do
    ...
    for table_cache_size in 10000; do
      ...
      log_file="SATune_${num_format2}_in${num_format3}_val${value_size}_mem${buffer_size_mb}MB_zipf${zipf_a}_CT0${ct0}_level1base${mb}_targetbase${target_file_base_mb}_Blk${blk_size}_Blkcache${blk_cache_size}_Tabcache${table_cache_size}.log"
